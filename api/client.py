...
class APIClient:
    ...
    def create_source(
        ...
        If `notebook_id` or `notebooks` is provided, the source is associated
        with those notebook(s). If both are omitted, the source is created
        without any notebook association.
        """
        data = {
            "type": source_type,
            "embed": embed,
