export const frFR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Le serveur API de RAG est injoignable",
  ...
  sources: {
    ...
    insightCountPlural: "{count} key insights extracted",
    insightCountSingle: "1 key insight extracted",
    insightDefinition: "An insight is an AI-generated summary, theme, or key takeaway extracted from this source.",
    contentLoadFailed: "Failed to render source content",
    contentProcessingMessage: "Content is still being processed...",
  ...
  settings: {
    ...
    filesHelp: "Une fois vos fichiers téléchargés et traités, ils ne sont plus nécessaires. La plupart des utilisateurs devraient autoriser RAG à supprimer automatiquement les fichiers du dossier de téléchargement.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Une nouvelle version de RAG est disponible.",
    upToDate: "À jour",
    unknown: "Inconnu",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configurez quels modèles utiliser pour les différents usages d'RAG",
    missingRequiredModels: "Modèles requis manquants : {models}. RAG pourrait ne pas fonctionner correctement sans eux.",
  ...
  apiKeys: {
    ...
    description: "Stockez les clés API de manière sécurisée dans la base de données pour activer les fournisseurs d'IA dans RAG.",
